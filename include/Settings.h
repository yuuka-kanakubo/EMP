	...
	public:
		...
		class Options{
			...
			public:
				...
				void set_minijet_freestream(int i){minijet_freestream=i;};
				...
				int get_minijet_freestream()const{return minijet_freestream;};
		...
		void init(int argc, char* argv[]){
			...
			for(int i=1; i<argc; i++) {
				...
				else if(!strcmp(argv[i],"--fs")){options.set_minijet_freestream(atoi(argv[i+1]));}
