...
inline const double tau0 = 0.75;//fm
...
inline  const double val_cent_pp5[11]={0.0001, 0.001, 0.01, 0.05, 0.10, 0.20, 0.30, 0.40, 0.50, 0.70, 1.0};
inline  const double val_cent_pp5_Xi[11]={0.001, 0.01, 0.05, 0.10, 0.15, 0.20, 0.30, 0.40, 0.50, 0.70, 1.0};
inline  const double val_cent_pp5_Omega[7]={0.01, 0.05, 0.15, 0.30, 0.50, 0.70, 1.0};
...
inline  const std::string name_cent_pp5[11]={"0-0.01pct","0.01-0.1pct", "0.1-1pct", "1-5pct","5-10pct","10-20pct","20-30pct", "30-40pct", "40-50pct", "50-70pct", "70-100pct"};
inline  const std::string name_cent_pp5_Xi[11]={"0-0.1pct", "0.1-1pct", "1-5pct","5-10pct","10-15pct","15-20pct","20-30pct", "30-40pct", "40-50pct", "50-70pct", "70-100pct"};
inline  const std::string name_cent_pp5_Omega[7]={"0-1pct","1-5pct","5-15pct","15-30pct", "30-50pct", "50-70pct", "70-100pct"};
